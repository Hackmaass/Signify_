...
export default function Dock({
  ...
  // For top-right placement, let's keep the panel height relatively constant or subtly animated
  // compared to a bottom dock which grows significantly.
  const heightRow = useTransform(isHovered, [0, 1], [panelHeight, panelHeight + 8]);
